...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../Include/common/skin/qingxin/skin.css" id="layout-skin"/>
  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			...
			<ul class="header-bar">
				...
				<li class="header-bar-nav">
					<a href="javascript:;"><%=Context.User.Identity.Name%><i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
		...
		<div class="layout-footer"> &copy;<%=DateTime.Now.Year %> 五邑大学</div>
	</div>
    <script type="text/javascript" src="../Include/common/lib/jquery-1.9.0.min.js"></script>
    <script type="text/javascript" src="../Include/common/js/sccl.js"></script>
    <script type="text/javascript" src="../Include/common/js/sccl-util.js"></script>
  </body>
</html>
